...
<body>
            ...
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" style="width: 1100;" method="post" action='regcode.php' enctype="multipart/form-data">
                    ...
                    <div class="container-login100-form-btn">
                        <button class="login100-form-btn" onclick="reg()" name="submit">
                            Login
                        </button>
                    </div>
    ...
    <script src="asessts/Newlogin/vendor/jquery/jquery-3.2.1.min.js"></script>
    <!--===============================================================================================-->
    <script src="asessts/Newlogin/vendor/bootstrap/js/popper.js"></script>
    <script src="asessts/Newlogin/vendor/bootstrap/js/bootstrap.min.js"></script>
    <!--===============================================================================================-->
    <script src="asessts/Newlogin/vendor/select2/select2.min.js"></script>
    <!--===============================================================================================-->
    <script src="asessts/Newlogin/vendor/tilt/tilt.jquery.min.js"></script>
    <script>
        $('.js-tilt').tilt({
            scale: 1.1
        })
    ...
    <script>
        function reg() {
            Swal.fire(
                ...
                'You will be directed to the login page upon completion of your registration',
                'info'
            )
        }
    </script>
    <!--===============================================================================================-->
    <script src="asessts/Newlogin/js/main.js"></script>
